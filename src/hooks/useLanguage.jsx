...
const translations = {
    ...
    bg: {
      ...
      testimonialsDescription: 'Историите на нашите клиенти говорят за стойността на инвестицията в професионална фотография и незабравимите спомени, които създаваме заедно.',
