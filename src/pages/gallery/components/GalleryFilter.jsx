...
const GalleryFilter = ({
  ...
  const categories = [
    ...
    { key: 'portraits', label: t?.categories?.portraits, icon: 'User' },
    { key: 'corporate', label: t?.categories?.corporate, icon: 'Briefcase' },
    { key: 'events', label: t?.categories?.events, icon: 'Calendar' }
  ];
